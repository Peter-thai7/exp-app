...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/reports/years', [ReportController::class, 'getAvailableYears'])->name('reports.years');

    // Hierarchical Reports
    Route::get('/reports/hierarchical', [ReportController::class, 'hierarchicalForm'])->name('reports.hierarchical');
    Route::post('/reports/hierarchical/generate', [ReportController::class, 'generateHierarchicalReport'])->name('reports.hierarchical.generate');
    
    // Drill-down API routes
    Route::get('/reports/month-daily-summaries/{year}/{month}', [ReportController::class, 'getMonthDailySummaries'])->name('reports.month-daily-summaries');
    Route::get('/reports/year-monthly-summaries/{year}', [ReportController::class, 'getYearMonthlySummaries'])->name('reports.year-monthly-summaries');
    Route::get('/reports/daily-details/{date}', [ReportController::class, 'getDailyDetails'])->name('reports.daily-details');
