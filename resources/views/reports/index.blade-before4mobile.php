        ...
        function updateExpenseList(expenses) {
            ...
            expenses.slice(0, 5).forEach(expense => {
                ...
                expenseItem.innerHTML = `
                    <div class="flex-1">
                        <div class="font-medium text-gray-800">${expense.type}</div>
                        <div class="text-sm text-gray-600">${expense.date} • ${expense.category}</div>
                    </div>
                    <div class="text-right">
                        <div class="font-bold text-green-600">${expense.amount.toLocaleString()} บาท</div>
                    </div>
                `;
            ...
            if (expenses.length > 5) {
                ...
                moreItem.className = 'text-center text-sm text-gray-500 mt-2';
                moreItem.textContent = `+ ${expenses.length - 5} รายการอื่นๆ`;
        ...
        function updateExpenseTable(expenses) {
            ...
            expenses.forEach(expense => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900">${expense.type}</td>
                    <td class="px-4 py-3 text-sm text-right text-green-600 font-medium">${expense.amount.toLocaleString()} บาท</td>
