...
<head>
    ...
    <title>รายงานตามปี - ระบบบันทึกค่าใช้จ่าย</title>
    ...
    <div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-white mb-2">รายงานตามปี</h1>
            ...
            <div class="bg-white rounded-2xl card-shadow overflow-hidden">
                ...
                <div class="divide-y">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between cursor-pointer" onclick="toggleDetails('year-{{ $loop->index }}')">
                        ...
                        <!-- Monthly Details -->
                        <div id="year-{{ $loop->index }}" class="mt-4 hidden">
                            <div class="bg-gray-50 rounded-lg p-4">
                                <h4 class="font-semibold text-gray-800 mb-4">สรุปรายเดือนในปี {{ $year->thai_year }}</h4>
                                <div class="space-y-3">
                                    @forelse($year->monthly_details as $month)
