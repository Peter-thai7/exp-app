            ...
            <div class="bg-white rounded-2xl p-6 card-shadow">
                ...
                <form action="{{ route('reports.hierarchical.generate') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="flex items-center p-4 border-2 border-blue-300 rounded-lg cursor-pointer">
                        ...
                        <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-red-300 transition">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                            ...
                            <div>
                                ...
                                <div class="text-red-600">2566 ถึง 2568</div>
                            </div>
                        </div>
                    </div>
