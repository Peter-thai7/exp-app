        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-2xl card-shadow overflow-hidden">
                ...
                <div class="divide-y">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between cursor-pointer hover:bg-gray-50 rounded-lg transition-colors" onclick="toggleDetails('day-{{ $loop->index }}')">
                        ...
                        <div id="day-{{ $loop->index }}" class="mt-4 hidden">
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border hover:shadow-sm transition-shadow">
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span class="font-semibold text-gray-800 text-lg">฿{{ number_format($expense->amount, 2) }}</span>
                                            </div>
                                            <div class="flex items-center space-x-4 text-sm text-gray-600">
                                                <span class="bg-blue-50 text-blue-700 px-2 py-1 rounded">
                                                    <i class="fas fa-tag mr-1"></i>
                                                    {{ $expense->type->category->name_th }}
                                                </span>
                                    ...
                                    <div class="text-center py-8 text-gray-500">
                                        ...
                                        <p class="text-lg">ไม่มีรายการค่าใช้จ่ายในวันนี้</p>
                                    </div>
                                    @endforelse
                                </div>
                            </div>
