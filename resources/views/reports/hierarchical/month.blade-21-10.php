        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-2xl card-shadow overflow-hidden">
                ...
                <div class="divide-y">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between cursor-pointer" onclick="toggleDetails('month-{{ $loop->index }}')">
                        ...
                        <!-- Daily Details -->
                        <div id="month-{{ $loop->index }}" class="mt-4 hidden">
                            <div class="bg-gray-50 rounded-lg p-4">
                                <h4 class="font-semibold text-gray-800 mb-4">สรุปรายวันในเดือน {{ $month->thai_month }}</h4>
                                <div class="space-y-3">
                                    @forelse($month->daily_details as $day)
